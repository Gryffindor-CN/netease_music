...
class CollectPageState extends State<CollectPage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    _tabController = new TabController(initialIndex:0,length: tabBarLength,vsync: this);
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      this.count['albumCount'] == 0?'':'${count['albumCount']}',
                      style: TextStyle(
                        fontSize: 12,
                      ),
                    ),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 1),
                    child: Text(
                      this.count['artistCount'] == 0?'':'${count['artistCount']}',
                      style: TextStyle(
                        fontSize: 12,
                      ),
                    ),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 1),
                    child: Text(
                      this.count['videoCount'] == 0?'':'${count['videoCount']}',
                      style: TextStyle(
                        fontSize: 12,
                      ),
                    ),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 1),
                    child: Text(
                      this.count['specialCount'] == 0?'':'${count['specialCount']}',
                      style: TextStyle(
                        fontSize: 12,
                      ),
                    ),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 1),
                    child: Text(
                      this.count['mlogCount'] == 0?'':'${count['mlogCount']}',
                      style: TextStyle(
                        fontSize: 12,
                      ),
                    ),
...
//        crossAxisAlignment: CrossAxisAlignment.end,
        children: <Widget>[
          Text("收藏的专辑",style: TextStyle(fontWeight: FontWeight.w700),),
