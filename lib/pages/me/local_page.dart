...
class LocalPageState extends State<LocalPage>
  ...
  final TextEditingController _searchArtistController =
      new TextEditingController();
  final TextEditingController _searchAlbumController =
      new TextEditingController();
            ...
            child: new Scaffold(
              appBar: new AppBar(
                ...
                title: new TabBar(
                  ...
                  indicatorPadding:
                      EdgeInsets.only(left: 15, bottom: 0, right: 15),
                  indicatorWeight: 1,
                  tabs: [
                    Tab(
                      child: Row(
                    ...
                    Tab(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(' ',
                              style: TextStyle(
                                  color: Color(0xffd0d0d0), fontSize: 23))
                        ],
                      ),
                    ),
                  ],
